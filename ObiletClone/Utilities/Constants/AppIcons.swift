...
enum AppIcons {
    ...
    static let myTrips = "duffle.bag.fill"
    static let promotions = "gift"
    static let help = "questionmark.circle"
    static let account = "person"
    static let accountFill = "person.fill"
    static let arrowUpDown = "arrow.up.arrow.down"
    static let filter = "slider.horizontal.3"
    static let changeArrow = "arrow.left.arrow.right.square"
    static let calendar = "calendar"
    static let chair = "chair.lounge"
    static let bus = "bus"
